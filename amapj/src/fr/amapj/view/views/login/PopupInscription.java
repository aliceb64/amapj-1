...
public class PopupInscription extends FormPopup {
...

	{
		...
		addLabel("Veuillez remplir les champs suivant relatifs � votre inscription<br/><br/>", ContentMode.HTML);

		addTextField("Nom*", "nom");

		addTextField("Nom ch�que*", "nom_paiement");

		addTextField("Pr�nom*", "prenom");
...

	{
	    ...
	    Notification.show("F�licitation, vous �tes inscrit", Type.WARNING_MESSAGE);
